...
public class DrawablePickerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener((parent, view, position, id) -> {
            SkinCompatUserThemeManager.get().addColorState(R.color.windowBackgroundColor, mAdapter.getItem(position));
    ...
    private static class ResolvePicTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... voids) {
            ...
            File[] files = new File(cameraDirPath).listFiles(pathname -> pathname.getName().endsWith(".jpg") || pathname.getName().endsWith(".png"));
